...
const FmgrBuiltin fmgr_builtins[] = {
  ...
  { 1843, 2, false, false, "interval_avg_accum", interval_avg_accum },
  { 1844, 1, false, false, "interval_avg", interval_avg },
  ...
  { 2622, 0, true, false, "pg_rotate_logfile", pg_rotate_logfile },
  ...
  { 2769, 0, true, false, "pg_stat_get_checkpointer_num_timed", pg_stat_get_checkpointer_num_timed },
  { 2770, 0, true, false, "pg_stat_get_checkpointer_num_requested", pg_stat_get_checkpointer_num_requested },
  { 2771, 0, true, false, "pg_stat_get_checkpointer_buffers_written", pg_stat_get_checkpointer_buffers_written },
  ...
  { 3160, 0, true, false, "pg_stat_get_checkpointer_write_time", pg_stat_get_checkpointer_write_time },
  { 3161, 0, true, false, "pg_stat_get_checkpointer_sync_time", pg_stat_get_checkpointer_sync_time },
  ...
  { 3325, 2, false, false, "interval_avg_combine", interval_avg_combine },
  ...
  { 3549, 2, false, false, "interval_avg_accum_inv", interval_avg_accum_inv },
  ...
  { 3577, 4, true, false, "pg_logical_emit_message_text", pg_logical_emit_message_text },
  { 3578, 4, true, false, "pg_logical_emit_message_bytea", pg_logical_emit_message_bytea },
  ...
  { 3775, 1, false, false, "pg_stat_reset_shared", pg_stat_reset_shared },
  ...
  { 3786, 5, true, false, "pg_create_logical_replication_slot", pg_create_logical_replication_slot },
  ...
  { 3813, 1, true, false, "xmltext", xmltext },
  ...
  { 4549, 0, true, false, "unicode_version", unicode_version },
  ...
  { 6099, 0, true, false, "icu_unicode_version", icu_unicode_version },
  { 6103, 1, true, false, "numeric_pg_lsn", numeric_pg_lsn },
  { 6105, 1, true, false, "unicode_assigned", unicode_assigned },
  ...
  { 6312, 1, true, false, "binary_upgrade_logical_slot_has_caught_up", binary_upgrade_logical_slot_has_caught_up },
  { 6314, 0, true, false, "pg_stat_get_checkpointer_stat_reset_time", pg_stat_get_checkpointer_stat_reset_time },
  { 6315, 1, true, false, "pg_basetype", pg_basetype },
  { 6316, 1, true, false, "pg_column_toast_chunk_id", pg_column_toast_chunk_id },
  { 6317, 1, true, false, "to_regtypemod", to_regtypemod },
  { 6318, 0, true, true, "pg_get_wait_events", pg_get_wait_events },
  { 6319, 4, false, false, "binary_upgrade_add_sub_rel_state", binary_upgrade_add_sub_rel_state },
  { 6320, 2, false, false, "binary_upgrade_replorigin_advance", binary_upgrade_replorigin_advance },
  { 6321, 0, true, true, "pg_available_wal_summaries", pg_available_wal_summaries },
  { 6322, 3, true, true, "pg_wal_summary_contents", pg_wal_summary_contents },
  { 6323, 0, true, false, "pg_get_wal_summarizer_state", pg_get_wal_summarizer_state },
  { 6324, 1, true, false, "interval_avg_serialize", interval_avg_serialize },
  { 6325, 2, true, false, "interval_avg_deserialize", interval_avg_deserialize },
  { 6326, 1, false, false, "interval_sum", interval_sum },
  { 6327, 0, true, false, "pg_stat_get_checkpointer_restartpoints_timed", pg_stat_get_checkpointer_restartpoints_timed },
  { 6328, 0, true, false, "pg_stat_get_checkpointer_restartpoints_requested", pg_stat_get_checkpointer_restartpoints_requested },
  { 6329, 0, true, false, "pg_stat_get_checkpointer_restartpoints_performed", pg_stat_get_checkpointer_restartpoints_performed },
  { 6330, 1, true, false, "to_bin32", to_bin32 },
  { 6331, 1, true, false, "to_bin64", to_bin64 },
  { 6332, 1, true, false, "to_oct32", to_oct32 },
  { 6333, 1, true, false, "to_oct64", to_oct64 },
  { 6334, 1, true, false, "timestamptz_at_local", timestamptz_at_local },
  { 6335, 1, true, false, "timestamp_at_local", timestamp_at_local },
  { 6336, 1, true, false, "timetz_at_local", timetz_at_local },
  { 6338, 2, false, false, "jsonb_populate_record_valid", jsonb_populate_record_valid },
  { 6339, 2, true, false, "int4random", int4random },
  { 6340, 2, true, false, "int8random", int8random },
  { 6341, 2, true, false, "numeric_random", numeric_random },
  { 6342, 1, true, false, "uuid_extract_timestamp", uuid_extract_timestamp },
  { 6343, 1, true, false, "uuid_extract_version", uuid_extract_version },
  { 6344, 0, true, false, "pg_sync_replication_slots", pg_sync_replication_slots },
  { 6345, 1, true, false, "range_contains_elem_support", range_contains_elem_support },
  { 6346, 1, true, false, "elem_contained_by_range_support", elem_contained_by_range_support }
};

const int fmgr_nbuiltins = (sizeof(fmgr_builtins) / sizeof(FmgrBuiltin));

const Oid fmgr_last_builtin_oid = 6346;

const uint16 fmgr_builtin_oid_index[6347] = {
