...
#define CONFIGURE_ARGS " '--host=x86_64-w64-mingw32' '--prefix=/e/programs/pgInstaller/' '-with-openssl' '-enable-debug' 'host_alias=x86_64-w64-mingw32' 'PKG_CONFIG_PATH=/mingw64/lib/pkgconfig:/mingw64/share/pkgconfig'"
